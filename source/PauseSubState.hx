...
class PauseSubState extends MusicBeatSubstate
{
	...
	//bush copied and pasted this code lol
	//Facts
	...
	public function new(x:Float, y:Float)
	{
		...
		DiscordClient.changePresence(PlayState.detailsPausedText, PlayState.SONG.song + " (" + PlayState.storyDifficultyText + ")", PlayState.iconRPC);

		Application.current.window.title = 'Nike Engine - Paused';
		#end
	...
	override function update(elapsed:Float)
	{
		...
		if (accepted)
		{
			...
			switch (daSelected)
			{
				case "Resume":
					#if desktop
					Application.current.window.title = 'Nike Engine - Playing: ' + PlayState.SONG.song + ' - ' + PlayState.storyDifficultyText;
					#end
					close();
				case "Restart Song":
					FlxG.resetState();
