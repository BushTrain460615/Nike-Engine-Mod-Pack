...
class Settings extends MusicBeatSubstate
{
	...
	public static var HideRatings:Bool = false;
	...
	public static var Week8Unlocked:Bool = false;
	...
	*/ //this code sucks dick
	...
	public static function SaveShit() {
		...
		FlxG.save.data.HideRatings = HideRatings;
		...
		FlxG.save.data.WeekProgression = WeekProgression;
		...
		if (WeekProgression) {
			...
			FlxG.save.data.Week8Unlocked = Week8Unlocked;
		}
	}
	...
	public static function LoadSettings() {
		...
		if(FlxG.save.data.HideRatings != null) {
			HideRatings = FlxG.save.data.HideRatings;
		}
		...
		if (WeekProgression) {
			...
			if(FlxG.save.data.Week8Unlocked != null) {
				Week8Unlocked = FlxG.save.data.Week8Unlocked;
			}
		}
		else {
			Week2Unlocked = true;
